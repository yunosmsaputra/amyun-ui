...
export const MonthPickerContainerStyles = styled.div<{
  ...
  $onFocused?: boolean;
    ...
    line-height: 16px;
    font-size: 12px;
    border: 1px solid ${(props) => props.$onFocused ? blueColorLib.border : neutralColorLib.stroke};
    border-radius: 6px;
    color: ${(props) => props.$emptyValue ? neutralColorLib.textField : neutralColorLib.black};
    background-color: ${(props) => props.$disabled ? neutralColorLib.disbled : neutralColorLib.white};
    cursor: pointer;
`
...
export const MonthPickerPopupMonthStyles = styled.div<{
  ...
  $monthNow?: boolean;
    ...
    width: 72px;
    height: 48px;
    background-color: ${(props) => props.$active ? blueColorLib.main : neutralColorLib.white};
    color: ${(props) => props.$active ? neutralColorLib.white : props.$monthNow ? blueColorLib.main : neutralColorLib.black};
    font-weight: ${(props) => props.$active || props.$monthNow ? 600 : 'normal'};
    border-radius: 8px;
    &:hover {
        cursor: pointer;
        background-color: ${(props) => props.$active ? blueColorLib.main : blueColorLib.surface};
        color: ${(props) => props.$active ? neutralColorLib.white : blueColorLib.main};
        font-weight: 600;
    }
`
