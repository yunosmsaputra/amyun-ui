...
import Sidebar, {
  AmSidebarAppIcon, AmSideBarAppIconMain, AmSidebarAppIconMini,
  AmSidebarMenu, AmSideBarMenuChild, AmSideBarMenuChildItem,
  AmSideBarMenuIcon, AmSideBarMenuIconActive, AmSideBarMenuIconState,
  AmSideBarMenuText,
} from './Sidebar';
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'For use router in sidemenu use function <b>onClick()</b> on tag <i>AmSidebarMenu</i>'
      }
    }
  }
    ...
    children: [
      <AmSidebarAppIcon>
        <AmSideBarAppIconMain>
          <img alt={''} src={'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Logo_PLN.svg/2560px-Logo_PLN.svg.png'} style={{maxHeight: '46px'}} />
        </AmSideBarAppIconMain>
        <AmSidebarAppIconMini>
          <img alt={''} src={'https://upload.wikimedia.org/wikipedia/commons/9/97/Logo_PLN.png'} width={'32px'} height={'46px'}/>
        </AmSidebarAppIconMini>
      </AmSidebarAppIcon>,
      ...
      <AmSidebarMenu menuIndex={'master'}>
        <AmSideBarMenuIcon>
          ...
          <AmSideBarMenuIconActive>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
              <path
                  d="M1 4C1 4.79565 1.84285 5.55871 3.34315 6.12132C4.84344 6.68393 6.87827 7 9 7C11.1217 7 13.1566 6.68393 14.6569 6.12132C16.1571 5.55871 17 4.79565 17 4C17 3.20435 16.1571 2.44129 14.6569 1.87868C13.1566 1.31607 11.1217 1 9 1C6.87827 1 4.84344 1.31607 3.34315 1.87868C1.84285 2.44129 1 3.20435 1 4Z"
                  stroke="#2671d9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path
                  d="M1 4V10C1 10.7956 1.84285 11.5587 3.34315 12.1213C4.84344 12.6839 6.87827 13 9 13C11.1217 13 13.1566 12.6839 14.6569 12.1213C16.1571 11.5587 17 10.7956 17 10V4"
                  stroke="#2671d9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path
        ...
        <AmSideBarMenuChild>
          <AmSideBarMenuChildItem>Unit</AmSideBarMenuChildItem>
        </AmSideBarMenuChild>
      </AmSidebarMenu>,
    ],
  },
